...
<html>
<head>
  <title>Тренер| Лист событий</title>
            ...
            <div class="panel-body no-padding" style="display: block;">
              <table class="table table-striped">
                ...
                <tr class="warning">
                  ...
                  <th>Зал</th>
                  <th>Дата</th>
                  <th><i class="fa fa-minus-circle" title="Участники"/></th>
                  <th><i class="glyphicon glyphicon-trash" title="Ответы"/> </th>
                </tr>
                </thead>
                <tbody>
                <c:forEach items="${events}" var="event">
                  <tr>
                    ...
                    <td><a href="participant_list?id=${event.id}">Участники</a></td>
                    <td><a href="participant_answer?id=${event.id}">Ответы</a> </td>
                  </tr>
                </c:forEach>
