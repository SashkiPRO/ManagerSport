      ...
      <div class="container">
        <div class="row">
          ...
          <div class="tab-content">
            ...
            <H2 class="form-heading" >Добавить новость</H2>
            <div class="tab-pane active" id="horizontal-form">
              <form:form modelAttribute="newNews" method="post" cssClass="form-horizontal" >
                <div class="form-group">
                  <label for="focusedinput" class="col-sm-2 control-label">Заголовок <i class="fa fa-asterisk req"></i></label>
                  <div class="col-sm-8">
                    <form:input path="handler" type="text" class="form-control1" id="focusedinput" placeholder="Имя"/>
                    <span class="has-error"><form:errors path="handler" cssClass="has-warning"/>${errorName} </span>
                  </div>

                </div>
                <div class="form-group">
                  <label for="focusedinput" class="col-sm-2 control-label">Текст <i class="fa fa-asterisk req"></i></label>
                  <div class="col-sm-8">
                    <form:textarea path="text"  class="form-control1 newsTextarea" id="focusedinput" placeholder="Имя"/>
                    <span class="has-error"><form:errors path="text" cssClass="has-warning"/>${errorName} </span>
                  </div>
                  ...
                  <div class="form-group">
                    <label for="newsDate" class="col-sm-2 control-label">Дата события</label>
                    <div class="col-sm-8">
                      <div class='input-group' id='datetimepicker9'>
                        <form:input path="newsDate" type="date" id="newsDate" cssClass="form-control1"  />
