      ...
      <div class="container">
        <div class="row">
          ...
          <div class="tab-content">
            <H2 class="form-heading" >Добавить нового сотрудника</H2>
            <div class="tab-pane active" id="horizontal-form">
              <form:form modelAttribute="newUser" method="post" cssClass="form-horizontal" enctype="multipart/form-data">
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    ...
                    <span class="has-error">   <form:errors path="firstName" cssClass="has-error"></form:errors></span>
                  </div>
                ...
                <div class="form-group">
                  <label for="checkbox" class="col-sm-2 control-label">Роль пользователя</label>
                  <div class="col-sm-8">
                    <c:forEach var="role" items="${roles}">
                      <form:checkbox path="roles" cssClass="checkbox-inline"  value="${role}"/>   <span style="font-size: 14px;">${role.name}</span>
                    </c:forEach>
                       </div>
                </div>

            <div class="form-group">
              <label class="col-sm-2 control-label">Выберете фото</label>

              <input type="file" class="btn-default alert-warning" name="file" value="ADdd" id="files"/>

              </div>
               <div class="col-sm-10" style="margin-left: 12em"><img id="image"></div>
