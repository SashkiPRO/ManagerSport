          ...
          <div class="media">
            ...
            <div class="media-body">
              ...
              <table class="table">
                ...
                <tr><td><span>Дата подписания контракта: </span></td><td>${user.contract.startDateString}</td></tr>
                <tr><td><span>Длительность контракта: </span></td><td>${user.contract.during}</td></tr>
                <tr><td><span>Зарплата: </span></td><td>${user.contract.salary}</td></tr>
                <tr><td><span>Контракт(PDF: </span></td><td><a href="#">Просмотр</a></td></tr>
                <tr><td><a class="btn btn-info" href="edit_contract?id=${user.contract.id}">Редактировать</a> </td></tr>
              </table>
