        ...
        <div class="container">
          <div class="row">
            <div class="tab-content">
              <H2 class="form-heading" >Добавить контракт</H2>
              <div class="tab-pane active" id="horizontal-form">
                <form:form modelAttribute="newContract" method="post" cssClass="form-horizontal" enctype="multipart/form-data">
                  <div class="form-group">
                    <label for="type_event" class="col-sm-2 control-label">Сотрудник <i class="fa fa-asterisk req"></i></label>
                    <div class="col-sm-8">
                      <form:select cssClass="form-control1" path="user" id="type">
                        <form:option value="" id="type_event">Сотрудник</form:option>
                  ...
                  <div class="form-group">
                    <label for="focusedinput" class="col-sm-2 control-label">Зарплата <i class="fa fa-asterisk req"></i></label>
                    <div class="col-sm-8">
                      <form:input path="salary" type="text" class="form-control1" id="focusedinput" placeholder="E-mail"/>
                      <span class="has-error"><form:errors path="salary" cssClass="has-warning"/>${errorName} </span>
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="focusedinput" class="col-sm-2 control-label">Срок контракта <i class="fa fa-asterisk req"></i></label>
                    <div class="col-sm-8">
                      <form:input path="during" type="text" class="form-control1" id="focusedinput" placeholder="E-mail"/>
                      <span class="has-error"><form:errors path="during" cssClass="has-warning"/>${errorName} </span>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-8">
                      <div class='input-group' id='datetimepicker9'>
                        <form:input path="dateStart" id="date" cssClass="form-control1"  />
