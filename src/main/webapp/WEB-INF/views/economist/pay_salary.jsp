        ...
        <div class="container">
          <div class="row">
            <div class="tab-content">
              <H2 class="form-heading" >Выплата зарплаты</H2>
              <div class="tab-pane active" id="horizontal-form">
                <form:form modelAttribute="container" method="post" cssClass="form-horizontal">
                 ...
                 <tr>
                    ...
                    <c:forEach items="${container.salaryList}" var="salary" varStatus="status">
                      <tr>
                        <td>${salary.user.firstName}</td>
                        <td>${salary.user.lastName}</td>
                        <td>
                          <form:input path="salaryList[${status.index}].amount"  />
                        </td>
                        <td>
                         <%-- <form:input path="salaryList[${status.index}].user"/>--%>
                          <form:hidden path="salaryList[${status.index}].user"/>
                        </td>
                      </tr>
                    </c:forEach>
