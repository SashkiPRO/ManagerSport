        ...
        <div class="container">
          <div class="row">
            <div class="tab-content">
              <H2 class="form-heading" >Назначить штраф</H2>
              <div class="tab-pane active" id="horizontal-form">
                <form:form modelAttribute="newPenalty" method="post" cssClass="form-horizontal" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    <label for="focusedinput" class="col-sm-2 control-label">Размер штрафа<i class="fa fa-asterisk req"></i></label>
                    <div class="col-sm-8">
                      <form:input path="amount" type="text" class="form-control1" id="focusedinput" placeholder="Значение"/>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <form:input path="description" type="text" class="form-control1" id="focusedinput" placeholder="Описание"/>
