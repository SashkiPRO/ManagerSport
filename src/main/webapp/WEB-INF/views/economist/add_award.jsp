        ...
        <div class="container">
          <div class="row">
            <div class="tab-content">
              <H2 class="form-heading" >Назначить премию</H2>
              <div class="tab-pane active" id="horizontal-form">
                <form:form modelAttribute="newAward" method="post" cssClass="form-horizontal" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    <label for="focusedinput" class="col-sm-2 control-label">Размер премии<i class="fa fa-asterisk req"></i></label>
                    <div class="col-sm-8">
