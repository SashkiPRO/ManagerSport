        ...
        <div class="container">
          <div class="row">
            <div class="tab-content">
              <H2 class="form-heading" >Изменить условия контракта</H2>
              <div class="tab-pane active" id="horizontal-form">
                <form:form modelAttribute="contract" method="post" cssClass="form-horizontal">
                ${contract.user.firstName}
                ${contract.user.lastName}
                  <form:hidden path="user" value="${contract.user.id}"/>
