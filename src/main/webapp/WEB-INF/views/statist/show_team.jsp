      ...
      <div class="graphs">
        ...
        <div class="row col-lg-11">
          <div class="panel panel-warning" data-widget="{&quot;draggable&quot;: &quot;false&quot;}" data-widget-static="">
            ...
            <div class="col-sm-3">
              <img src="ImageShow?type=team&id=${team.id}" style="width: 150px; height: 150px;">
            </div>
              <h1 class="float-left col-sm-9 ">${team.name}</h1>
            ...
            <div class="panel-body no-padding" style="display: block;">
              <table class="table table-striped">
                ...
                <tr class="warning">
                <tr><td>№</th><th>Игрок</th><th><img src="${contextPath}/resources/images/game.png"></th><th><img src="${contextPath}/resources/images/ball.png"></th><th><img src="${contextPath}/resources/images/yellow.png"></th><th><img src="${contextPath}/resources/images/red.png"></th><th><img src="${contextPath}/resources/images/position.png"></th><th></th></tr>
                </tr>
                </thead>
                <tbody>
                  ...
                  <c:forEach items="${players}" var="player">
                    ...
                    <tr><td>${player.number}</td><td>${player.firstName} ${player.lastName}</td><td>${player.games.size()}</td><td>${player.goals.size()}</td><td>${player.yellowCards.size()}</td><td>${player.redCards.size()}</td><td>GK</td><td> <a href="view_player_info?id=${player.id}"> Просмотреть</a></td></tr>
